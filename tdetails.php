...
<ul>
  ...
  <li class="active"><a href="theatre.php">Theatres</a></li>
...
$get_mov="select * from theatre where id='$mov_id'";
...
<div id='movie_box' class='dashdiv' style='
    ...
    border-radius: 8px;
    margin-bottom: 40px;'>
<img width='400' height='400' src='admin_area/theatre_images/$image' style='margin-top:25px; border: 2px solid grey;
    border-radius: 8px;'/>
...
$get_run="select * from running  where theatre_id='$mov_id' and date='$today' order by time";
$run_run=mysqli_query($con,$get_run);
$count=mysqli_num_rows($run_run);
if($count==0)
{echo "<p style='color:red;'>No Shows today for this movie in this theatre</p>
        <p>You can advance book tickets <i>(Upto 5 days) </i> for this movie by clicking this <a href='acamedics.php'>link</a>.</p>";

}
else
{
  echo "<p style='color:red;'>Book your tickets for <b>today's</b> show through the following links directly.</p>
<p><b><u>Movie Name</u>&nbsp&nbsp&nbsp <u>Showtime</u></b></p>"; 
}
...
echo"<br><br><a href='theatre.php' style='float:left; padding-top:5px;'><img src='gb.png' style='width:160px; height:65px;'></a>
