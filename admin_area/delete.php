...
$get_movs="delete from movies where id=$movie_id";
$run_movs=mysqli_query($con,$get_movs);
echo "<script>alert('THE MOVIE HAS BEEN DELETED!')</script>";
...
$get_the="delete from theatre where id=$theatre_id";
$run_the=mysqli_query($con,$get_the);
echo "<script>alert('THE THEATRE HAS BEEN DELETED!')</script>";
...
$get_cus="delete from running where id=$run_id";
$run_cus=mysqli_query($con,$get_cus);
echo "<script>alert('THE RUNNING MOVIE IS DELETED!')</script>";
