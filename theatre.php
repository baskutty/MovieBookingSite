...
<h1 style="text-align: center;">Theatre List</h1>
</center>
<?php
$con=mysqli_connect("localhost","root","","webp");
$get_mov="select * from theatre order by id desc";
...
<a href='tdetails.php?the_id=$id'><img width='240' height='240' src='admin_area/theatre_images/$image'  style=' border: 2px solid grey;
    border-radius: 8px;'/></a>
<br>
<a href='tdetails.php?the_id=$id'><h4 style='color:rgb(0,69,135);'>$name</h4></a>
<br>
